...
export default function LoginPage() {
  const handleLogin = () => {
    // google provider로 로그인, 로그인 후 홈('/')으로 리다이렉트
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            <div className="flex flex-col items-center p-3 bg-brand-50 dark:bg-slate-800 rounded-xl">
              ...
              <span className="text-xs font-medium text-slate-600 dark:text-slate-300">AI 감성 분석</span>
            </div>
            <div className="flex flex-col items-center p-3 bg-brand-50 dark:bg-slate-800 rounded-xl">
              <Music className="text-brand-500 mb-2" size={20} />
              <span className="text-xs font-medium text-slate-600 dark:text-slate-300">YouTube 재생</span>
            </div>
          </div>
